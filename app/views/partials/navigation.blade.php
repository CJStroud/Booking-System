        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="{{ route('booking.show.user') }}"><i class="fa fa-calendar fa-lg icon-spacing-right"></i>My Bookings</a></li>
                </ul>
            </li>
          @if (Auth::check() && Auth::user()->is_admin)
          <li><a href="{{ route('admin.home') }}"><i class="fa fa-gears fa-lg icon-spacing-right"></i>Admin</a></li>
          @endif
        </ul>
